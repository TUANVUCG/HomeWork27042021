...
public class Main {
        ...
        do{
            ...
            switch (choice){
                ...
                case "2":
                    ...
                    break;
                case "3":
                    updateStudentById(manager, sc);
                    break;
                case "4":
                    removeStudentById(manager, sc);
                    break;
                case "5":
    ...
    private static void searchStudentById(Manager manager, Scanner sc) {
        System.out.println("Nhập mã sinh viên cần tìm : "); // Done
        int id1 = Integer.parseInt(sc.nextLine());
        manager.showStudentInfoById(id1);
    }

    private static void removeStudentById(Manager manager, Scanner sc) {
        System.out.print("Nhập mã sinh viên cần xóa : ");//Done
        int id = Integer.parseInt(sc.nextLine());
        manager.removeStudentById(id);
    }

    private static void updateStudentById(Manager manager, Scanner sc) {
